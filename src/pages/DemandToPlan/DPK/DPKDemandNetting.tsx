...
const DPKDemandNetting: React.FC = () => {
  ...
  const [selectedMaterial, setSelectedMaterial] = useState<string>('Air Filter');
  ...
  const materialNettingData: MaterialNettingData = useMemo(() => ({
   ...
   'Air Filter': {
     adjustedTotal: 25920,
     inventoryTotal: 13720,
     contractTotal: 4000,
     transferTotal: 200,
     procurementTotal: 8000,
     unitPrice: 2500000,
     ...
     monthlyData: [
       ...
       { month: 'Aug', adjustedDemand: 2100, inventoryFulfillment: 1200, contractFulfillment: 400, stockTransfer: 20, netProcurement: 480, unitPrice: 2500000, totalAmount: 1200000000 },
       { month: 'Sep', adjustedDemand: 2200, inventoryFulfillment: 1200, contractFulfillment: 400, stockTransfer: 10, netProcurement: 590, unitPrice: 2500000, totalAmount: 1475000000 },
       { month: 'Oct', adjustedDemand: 2200, inventoryFulfillment: 1100, contractFulfillment: 400, stockTransfer: 10, netProcurement: 690, unitPrice: 2500000, totalAmount: 1725000000 },
       { month: 'Nov', adjustedDemand: 2200, inventoryFulfillment: 1200, contractFulfillment: 400, stockTransfer: 10, netProcurement: 590, unitPrice: 2500000, totalAmount: 1475000000 },
       { month: 'Dec', adjustedDemand: 2120, inventoryFulfillment: 1020, contractFulfillment: 200, stockTransfer: 10, netProcurement: 890, unitPrice: 2500000, totalAmount: 2225000000 }
     ]
   },
   'Fuel Filter': {
     adjustedTotal: 20920,
